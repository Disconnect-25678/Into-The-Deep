...
@Config
@Autonomous
public class Specimen2PathsAlt extends LinearOpMode {
    ...
    public static PublicPose P_SAMPLE_2 = new PublicPose(-72+22.780841799709727, 66, 270);
    public static PublicPose P_SCORE_POSE_2 = new PublicPose(-72+78, 72-32, 270);
    public static PublicPose P_SPEC_1 = new PublicPose(-72+22.780841799709727, 66, 270);
    public static PublicPose P_SCORE_POSE_3= new PublicPose(-72+79, 72-32, 270);


    public static double holdTheta = 274;
    ...
    public static PublicPose C_CONTROL_4 = new PublicPose(-72+34.484760522496366, -24, 0);
