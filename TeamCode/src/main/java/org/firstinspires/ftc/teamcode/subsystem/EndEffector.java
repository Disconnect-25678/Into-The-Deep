...
//    public static WristTwistAngles ANGLES_BUCKET = new WristTwistAngles(0.65, 0.15);
    ...
    public static WristTwistAngles ANGLES_INTAKE_GROUND_ROTATED = new WristTwistAngles(0.13, 0.35);


    public static double ARM_INTAKE_GROUND_MID = 0.17;
    public static double ARM_INTAKE_GROUND_HOVER = 0.14;
    public static double ARM_INTAKE_GROUND = 0.03;
    public static double ARM_INTAKE_REAR = 0.75;
    public static double ARM_BUCKET = 0.75;
    public static double ARM_SUB = 0.4;
    ...
    public static long TIME_WAIT_STWIST = 200;
...
//        this.wristTwistAnglesTarget = angles;
    ...
    public void setGroundIntakeArm() {
        this.setArmPosition(ARM_INTAKE_GROUND);
    }
    ...
    public void setGroundIntakeMidArm() {
        this.setArmPosition(ARM_INTAKE_GROUND_HOVER);
    }
    ...
    public void setGroundIntakeRotated() {
        this.setAngles(ANGLES_INTAKE_GROUND_ROTATED);
    }

    public void setGroundIntakeWrist() {
        this.setAngles(ANGLES_INTAKE_GROUND);
    }
