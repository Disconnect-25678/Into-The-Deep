...
@Config
@Autonomous
public class SpecimenMainAlt extends LinearOpMode {
    public static PublicPose P_START_POSE = new PublicPose(-72+68, 72-0, (270));
    public static PublicPose P_SCORE_POSE = new PublicPose(-72+78, 44.1, (270));
    public static PublicPose P_PARK_POSE = new PublicPose(-72+24, 53, (278));
    public static PublicPose P_SAMPLE_1 = new PublicPose(-72+32.60377358490565, 68.5, 270);
    public static PublicPose P_SAMPLE_2 = new PublicPose(-72+20.899854862119014, 58.4, 270);
    public static PublicPose P_SCORE_POSE_2 = new PublicPose(12, 43, 276);
    public static PublicPose P_SPEC_1 = new PublicPose(-72+22.780841799709727, 62.9, 281);
    public static PublicPose P_SCORE_POSE_3= new PublicPose(25.5, 42, 281);


    public static double holdTheta = 270;


    public static int POS_LIFT_SCORE_READY_MOVE = 1100;

    public static long TIME_SETTLE_SPECIMEN_PICKUP = 400;

    public static PublicPose C_CONTROL_1 = new PublicPose(-72+25.497822931785198, 72 - 28.841799709724235, 0);
    public static PublicPose C_CONTROL_2 = new PublicPose(-72+46.8156748911466, 72+1, 0);
    ...
    public static PublicPose C_CONTROL_B2 = new PublicPose(-72+20.899854862119014, 72-38.664731494920176, 0);
    public static PublicPose C_CONTROL_B3 = new PublicPose(-72+48.69666182873731, 72-63.535558780841804, 0);
    public static PublicPose C_CONTROL_B4 = new PublicPose(-72+16.51088534107403, -42, 0);
    public static PublicPose C_CONTROL_B5 = new PublicPose(-72+20.481857764876626, 72-29.88679245283019, 0);

    public static PublicPose C_CONTROL_C1 = new PublicPose(-72+17.13788098693758, 72-36.574746008708274, 0);

    public static PublicPose I_SEPCIMEN_INBETWEEN = new PublicPose(-72+22.780841799709727, 50, 281);

    private AutoDrivetrain follower;

    private PathChain p_ScorePreload;
    private PathChain p_Samp1;
    ...
    public void runOpMode() {
        ...
        p_Samp1 = follower.pathBuilder()
                ...
                ).setConstantHeadingInterpolation(Math.toRadians(holdTheta))
//                .addPath(
//                        new BezierCurve(
//                                P_SAMPLE_1.toPedroPoint(),
...
//                ).setConstantHeadingInterpolation(Math.toRadians(holdTheta))
        ...
        p_Collect_1 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                P_SCORE_POSE_2.toPedroPoint(),
                                C_CONTROL_C1.toPedroPoint(),
                                I_SEPCIMEN_INBETWEEN.toPedroPoint()
                        )
                ).setLinearHeadingInterpolation(P_SCORE_POSE_2.toPedroPose().getHeading(), I_SEPCIMEN_INBETWEEN.toPedroPose().getHeading())
                .addPath(
                        new BezierLine(
                                I_SEPCIMEN_INBETWEEN.toPedroPoint(),
                                P_SPEC_1.toPedroPoint()
                        )
                ).setLinearHeadingInterpolation(I_SEPCIMEN_INBETWEEN.toPedroPose().getHeading(), P_SPEC_1.toPedroPose().getHeading())
                .build();
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new ParallelCommandGroup(
                                ...
                                new FollowPathCommand(follower, p_Samp1, false)
                        ),
                        ...
                        new WaitCommand(TIME_SETTLE_SPECIMEN_PICKUP),
                        new InstantCommand(effector::grab, effector),
                        new WaitCommand(EndEffector.TIME_GRAB_SPECIMEN),
                        new ParallelCommandGroup(
